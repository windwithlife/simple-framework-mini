// @ts-ignore
/* eslint-disable */
import Taro, { setStorageSync as _setStorageSync, removeStorageSync as _removeStorageSync, getStorageSync as _getStorageSync, request as _request, showToast as _showToast } from "@tarojs/taro-h5";
...
console.log("Gateway===>https://api.zhangyongqiao.com");
    ...
    return new Promise((resolve, reject) => {
      _request({
        ...
        fail(error) {
          ...
          logError('get', '网络异常');
          reject(error);
          _showToast({ title: '接口异常', icon: 'error', duration: 2000 });
        }
      });
    });
  }
